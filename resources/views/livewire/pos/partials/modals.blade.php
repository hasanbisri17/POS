    ...
    <div class="fixed inset-0 overflow-hidden z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-xl text-left overflow-hidden shadow-xl border border-gray-200 dark:border-gray-700 transform transition-all sm:my-8 sm:align-middle w-full max-w-lg">
                <div class="bg-white dark:bg-gray-800 px-6 pt-10 pb-4 sm:p-8">
                    <div class="flex items-start justify-between mb-5">
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100 leading-6">
                                {{ $selected_product->name }}
                            </h3>
                            <p class="text-lg text-orange-600 dark:text-orange-400 font-medium mt-2">
                    ...
                    @if($selected_product->variants->isNotEmpty())
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Varian</label>
                                    ...
                                    <button type="button"
                                        ...
                                        class="relative w-full text-left px-4 py-3 rounded-lg transition-all duration-200
                                            {{ $selected_variant == $variant->id 
                                                ? 'border-2 border-orange-500 dark:border-orange-400 bg-orange-50 dark:bg-orange-900/20 ring-2 ring-orange-200 dark:ring-orange-800' 
                                                : 'border border-gray-200 dark:border-gray-600 hover:border-orange-200 dark:hover:border-orange-600 hover:bg-orange-50/50 dark:hover:bg-orange-900/10' }}">
                                        <div class="flex justify-between items-start">
                                            <div>
                                                <span class="block font-medium text-gray-900 dark:text-gray-100">{{ $variant->name }}</span>
                                                <span class="block text-sm text-orange-600 dark:text-orange-400 mt-0.5">
                                                    +Rp {{ number_format($variant->price_adjustment, 0, ',', '.') }}
                                                </span>
                                            </div>
                                            @if($selected_variant == $variant->id)
                                                <span class="text-orange-500 dark:text-orange-400 ml-2">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center justify-center space-x-3">
                            <button type="button" wire:click="decrementQuantity"
                                class="inline-flex items-center justify-center w-12 h-12 rounded-lg border border-gray-200 dark:border-gray-600 
                                       text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-700 dark:hover:text-gray-200 focus:outline-none 
                                       focus:ring-2 focus:ring-orange-200 dark:focus:ring-orange-800 transition-colors">
                            ...
                            <input type="number" 
                                wire:model="quantity" 
                                class="w-24 text-center text-lg rounded-lg border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-orange-300 dark:focus:border-orange-500 
                                       focus:ring focus:ring-orange-200 dark:focus:ring-orange-800 focus:ring-opacity-50"
                                min="1">
